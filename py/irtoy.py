    ...
    def transmit(self, code):
        ...
        try:
            ...
            if byte_count != total_bytes:
                raise IRTransmitError(f"Failed to transmit IR code, only sent {byte_count}/{total_bytes}")
...
if __name__ == '__main__':
    import serial, sys
    with serial.Serial("/dev/serial/by-id/usb-flaviutamas.com_p_ir-pico_RP2040_Infrared_remote_transceiver__IR_Toy__0000001-if00", timeout=2, write_timeout=2) as serial_device:
        connection = IrToy(serial_device)
        for _ in range(3):
            connection.transmit([1, 167, 0, 211, 0, 28, 0, 23, 0, 27, 0, 79, 0, 28, 0, 23, 0, 27, 0, 79, 0, 28, 0, 23, 0, 27, 0, 79, 0, 27, 0, 77, 0, 27, 0, 77, 0, 28, 0, 77, 0, 27, 0, 77, 0, 27, 0, 77, 0, 27, 0, 23, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 79, 0, 27, 0, 77, 0, 28, 0, 77, 0, 27, 0, 77, 0, 27, 0, 77, 0, 27, 0, 24, 0, 27, 0, 79, 0, 27, 0, 23, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 79, 0, 27, 0, 24, 0, 27, 0, 79, 0, 28, 0, 77, 0, 28, 0, 77, 0, 28, 6, 238, 1, 167, 0, 211, 0, 28, 0, 23, 0, 27, 0, 79, 0, 28, 0, 23, 0, 27, 0, 79, 0, 28, 0, 23, 0, 27, 0, 79, 0, 27, 0, 77, 0, 28, 0, 77, 0, 28, 0, 77, 0, 28, 0, 77, 0, 27, 0, 77, 0, 27, 0, 23, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 79, 0, 27, 0, 77, 0, 27, 0, 77, 0, 27, 0, 77, 0, 27, 0, 77, 0, 28, 0, 23, 0, 27, 0, 79, 0, 27, 0, 23, 0, 27, 0, 25, 0, 27, 0, 79, 0, 27, 0, 24, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 79, 0, 27, 0, 23, 0, 27, 0, 79, 0, 27, 0, 77, 0, 28, 0, 23, 0, 27, 169, 96, 1, 167, 0, 212, 0, 27, 0, 23, 0, 27, 0, 79, 0, 27, 0, 23, 0, 27, 0, 79, 0, 27, 0, 23, 0, 27, 0, 79, 0, 27, 0, 77, 0, 27, 0, 77, 0, 27, 0, 77, 0, 28, 0, 77, 0, 28, 0, 76, 0, 29, 0, 23, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 79, 0, 27, 0, 76, 0, 29, 0, 77, 0, 27, 0, 77, 0, 27, 0, 77, 0, 27, 0, 23, 0, 27, 0, 78, 0, 29, 0, 23, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 79, 0, 27, 0, 23, 0, 27, 0, 79, 0, 27, 0, 77, 0, 27, 0, 77, 0, 27, 6, 238, 1, 167, 0, 211, 0, 28, 0, 23, 0, 27, 0, 79, 0, 27, 0, 23, 0, 27, 0, 79, 0, 28, 0, 23, 0, 27, 0, 79, 0, 27, 0, 77, 0, 27, 0, 77, 0, 27, 0, 77, 0, 28, 0, 77, 0, 27, 0, 77, 0, 28, 0, 23, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 79, 0, 27, 0, 77, 0, 27, 0, 77, 0, 27, 0, 77, 0, 27, 0, 77, 0, 28, 0, 23, 0, 27, 0, 79, 0, 27, 0, 23, 0, 27, 0, 25, 0, 27, 0, 79, 0, 27, 0, 23, 0, 27, 0, 25, 0, 27, 0, 25, 0, 27, 0, 79, 0, 28, 0, 23, 0, 27, 0, 79, 0, 26, 0, 79, 0, 27, 0, 23, 0, 27])
